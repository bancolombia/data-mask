...
public class StringSerializer extends StdSerializer<String> {
    ...
    public StringSerializer(int leftVisible, int rightVisible, boolean queryOnly, String format, DataCipher dataCipher) {
        super(String.class);
    ...
    public void serialize(String value, JsonGenerator generator, SerializerProvider provider) throws IOException {
        ...
        var maskedValue = MaskUtils.mask(value, leftVisible, rightVisible);
        if (queryOnly) {
